...
function App() {
	...
	const takeScreenshot = () => {
		...
		shapes.forEach(shape => {
			...
			const offsetX = (shapeRect.x) - (randomBoxRect.x+2);
			const offsetY = (shapeRect.y) - (randomBoxRect.y+2);

	
			// Convert to canvas coordinates relative to the video frame
			// const x = (offsetX / randomBoxWidth) * randomBoxWidth + randomBoxRect.left;
			// const y = (offsetY / randomBoxHeight) * randomBoxHeight + randomBoxRect.top;
			const x = (offsetX / randomBoxWidth) * (randomBoxWidth) + ((randomBoxWidth/2));
			const y = (offsetY / randomBoxHeight) * (randomBoxHeight) + ((randomBoxHeight/2));
